import { onDropEvent } from "./TaskBtn";

export function selectingTaskBtn({
  event,
      ...
      if (window.innerWidth <= 768) {
        ...
        if (
          ...
          if (clickedBtn.getAttribute("tabindex") === "-1") {
            ...
            onDropEvent({
              event,
              renderContextTaskBtn: renderContextColumnsComponent,
            });
            console.log("tabindex -1");
            // swapTabIndex({
            //   previousSelected: isTabIndexZeroAssignedToTaskBtn,
...
export function dragDropMobile({ event }) {}

export function selectingTaskBtnTouchstart({
  event,
  renderContextColumnsComponent,
  swapTabIndex,
  localStorageSwapIndex,
